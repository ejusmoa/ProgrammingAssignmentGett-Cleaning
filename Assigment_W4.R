Assigment_W4 <- function() {
        ...
        # Reads de activities from activity_labels.txt in a dataset and sets the names of the columns
        ...
        # Joins Activities_ID and Activity_Label by column "id"
        ...
        # Adds the string "avg_" at the beginning of each of the averages computed in the previous step 
